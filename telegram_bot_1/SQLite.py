...
def user_pass(message):
    ...
    markup.add(telebot.types.InlineKeyboardButton('Cписок пользователей', callback_data='users'))
    bot.send_message(message.chat.id, 'Регестрация завершена', reply_markup=markup)
